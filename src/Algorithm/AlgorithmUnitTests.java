...
public class AlgorithmUnitTests extends TestCase {
    public void test(){
       ...
       /* Section s1 = new Section(13524, classDays, Start, End, false, true, 2.0);
        ...
        Schedule schedule = new Schedule(sched, 0.0);

        Algorithm a1 = new Algorithm(sched, courses);
        schedule = a1.run();
        for(Section s:schedule.getCourses()){
            System.out.println(s);
        }
        System.out.println(schedule.getScore()); */
...
//        Start = "900";   // mw start 9am
//        End = "1030";    // mw end 10:30am
//        DatabaseSection s1 = new DatabaseSection(13524, classDays, Start, End, false, true);
//    }
